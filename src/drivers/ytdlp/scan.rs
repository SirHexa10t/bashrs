...
/// dead or alive.
pub(super) struct PlaylistScan {
    pub(super) title: String,
    pub(super) dirname: Option<String>,
    pub(super) entries: Vec<ScanEntry>,
}
...
pub(super) fn scan_tab(url: &str, dir_template: &str, env: Env) -> TabScan {
...
pub(super) fn scan_playlist(url: &str, dir_template: &str, env: Env) -> Option<PlaylistScan> {
...
pub(super) fn archived_ids(path: &Path) -> HashSet<String> {
...
pub(super) fn is_tombstone(title: &str) -> bool {
...
pub(super) fn unplayable_report(playlist_title: &str, playlist_id: &str, dead: &[&ScanEntry]) -> String {
...
mod tests {
    ...
    use crate::drivers::ytdlp::invocation::ARCHIVE_NAME;
