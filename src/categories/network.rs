...
mod commands {
    ...
    const PROBE_TARGETS: &[ProbeTarget] = &[
        ...
        ProbeTarget { provider: "Google", endpoint: "static CDN", host: "www.gstatic.com" },
        ProbeTarget { provider: "Google", endpoint: "public DNS", host: "dns.google" },
        ProbeTarget { provider: "Google", endpoint: "Cloud Storage", host: "storage.cloud.google.com" },
        ProbeTarget { provider: "Google", endpoint: "Cloud console", host: "cloud.google.com" },
        ProbeTarget { provider: "GitHub", endpoint: "web", host: "github.com" },
        ProbeTarget { provider: "GitHub", endpoint: "API", host: "api.github.com" },
        ProbeTarget { provider: "GitHub", endpoint: "archive download", host: "codeload.github.com" },
        ...
        ProbeTarget { provider: "Microsoft", endpoint: "Graph API", host: "graph.microsoft.com" },
